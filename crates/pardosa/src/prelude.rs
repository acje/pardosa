...
pub use crate::store::{
    ...
    GenerationKnowledge, HistoryIntegrity, IllegalOpenCombination, IllegalStateTransition,
    IncompleteCreationState, LivenessVerdict, LockedRescuePolicy, MigrationCompleteness,
